const Education = ({width}) => {
  return (
    <div className={`text-start display-6 d-flex flex-column justify-content-center align-items-start text-light ${width < 1200 ? 'px-3 mt-4' : 'px-5 border-start'}`}>
      ...
      <p className="fs-7 my-1">♦ FULL STACK DEVELOPER - Rolling Code School.</p>
      <p className="fs-7 my-1">♦ INGENIERIA CIVIL - Universidad Nacional de Tucumán (UNT) - Facultad de Ciencias Exactas y Tecnología, Tucumán, Argentina. (2013-2020)</p>
      <p className="fs-7 my-1">♦ FORMACION SECUNDARIA (Bachiller Científico) - Colegio Fasta Ángel María Boisdron, Tucumán, Argentina.</p>
      <p className="fs-6 my-2 text-decoration-underline">FORMACION COMPLEMENTARIA</p>
      <p className="fs-7 my-1">♦ TOEFL iBT (ETS). Año 2020. (High- Intermediate)</p>
      <p className="fs-7 my-1">♦ Capacitación en el software de cálculo estructural SAP2000. Spectra Calculistas Estructurales: 2020</p>
      <p className="fs-7 my-1">♦ Capacitación en el software de cálculo estructural CYPECAD. Spectra Calculistas Estructurales: 2019</p>
      ...
      <p className="fs-7 my-1">♦ Ayudante Estudiantil en la Facultad de Ciencias Exactas y Tecnología (2016 / 2017)</p>
    </div>
  );
};
